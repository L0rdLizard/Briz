<template>
    <div class="container p-2 rounded-4" style="margin-top: 40px; background-color: white; " >
        <div class="container-liquid row p-4 m-4 mt-3 rounded-4 custom-element1">
            ...
            <div class="container-liquid col-5 pt-3">
                <div class="row">
                    <p class="col d-flex justify-content-start align-items-start custom-font inter-400 pb-2 mt-1 mb-1" 
    ...
    <div class="container p-2 rounded-4" style="margin-top: 40px; background-color: white;">
        <div class="container-liquid row p-4 m-4 mt-3 rounded-4 custom-element1">
            ...
            <div class="container-liquid col-5 ">
